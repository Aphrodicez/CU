...
class Ship(pg.sprite.Sprite):
    def __init__(self, color, width, height):
        ...
        self.image = pg.image.load("Workshop10-pygame2/source/img/Ship.png")
...
class Meteor(pg.sprite.Sprite):
    def __init__(self, color, width, height):
        ...
        self.image = pg.image.load("Workshop10-pygame2/source/img/meteor_med.png")
        self.image = pg.transform.scale(self.image, (width, height))
...
myMeteor1 = Meteor(red, 50, 38)

# TO DO 5-3 : กำหนดพิกัดเริ่มต้นให้ Meteor [ x = 110 , y = 170]
myMeteor1.rect.x = 110
myMeteor1.rect.y = 170
...
all_sprites.add(myMeteor1)
meteor_sprites.add(myMeteor1)
...
while True:
    ...
    hits = pg.sprite.spritecollide(myShip, meteor_sprites, False)
    if len(hits) > 0:
        hits[0].moveRight(10)
